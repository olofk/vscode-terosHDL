...
const NETLIST_VIEWER = "Configure (https://terostechnology.github.io/terosHDLdoc/netlist/configuration.html) Yosys or install YoWASP: pip3 install yowasp-yosys";
